...
export class StudentsService {
  ...
  async update(id: number, updateStudentDto: UpdateStudentDto) {
    ...
    student.department = updateStudentDto.department || student.department;
    student.matriculationNumber = updateStudentDto.matriculationNumber || student.matriculationNumber;
    student.modeOfEntry = updateStudentDto.modeOfEntry || student.modeOfEntry;
    student.programOfStudy = updateStudentDto.programOfStudy || student.programOfStudy;
    student.yearOfEntry = updateStudentDto.yearOfEntry || student.yearOfEntry;
